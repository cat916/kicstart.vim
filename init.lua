...
require('lazy').setup({
...

  {
    ...
    keys = {
      ...
      { "<leader>hk", "<cmd>lua require('harpoon.mark').delete_current()<cr>",  desc = "Delete current harpoon mark" },
      { "<leader>h1", "<cmd>lua require('harpoon.ui').nav_file(1)<cr>",         desc = "Go to 1st mark" },
      { "<leader>h2", "<cmd>lua require('harpoon.ui').nav_file(2)<cr>",         desc = "Go to 2st mark" },
      { "<leader>h3", "<cmd>lua require('harpoon.ui').nav_file(3)<cr>",         desc = "Go to 3st mark" },
      { "<leader>h4", "<cmd>lua require('harpoon.ui').nav_file(4)<cr>",         desc = "Go to 4st mark" },
    },
  },
...
-- Highlight and move to next/prev search match
